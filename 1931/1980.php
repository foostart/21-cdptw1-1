...
$less = new lessc;
$less->compileFile('less/1980.less', 'css/1980.css');
?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <link href="<?php echo $url_path ?>/css/1980.css" rel="stylesheet" type="text/css"/>
        ...
        <script src="<?php echo $url_path ?>/js/1980.js" type="text/javascript"></script>
    ...
    <body> 
        <?php include '../1980/1980-content.php'; ?>
