...
<?php
    ...
    $less = new lessc;
    $less->compileFile('less/1652.less', 'css/1652.css');
?>
<html>
    <head>
        <title>Module-1652</title>
        <meta charset="UTF-8">
        ...
        <link href="<?php echo $url_path ?>/css/1652.css" rel="stylesheet" type="text/css"/>
        <script src="<?php echo $url_path ?>/js/jquery-2.1.4.min.js" type="text/javascript"></script>
        <script src="<?php echo $url_path ?>/js/1652.js" type="text/javascript"></script>

    </head>
    <body>
        <?php include './module-1652-content.php'; ?>
    </body>
</html>