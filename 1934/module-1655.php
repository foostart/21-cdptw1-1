...
<?php
    ...
    $less = new lessc;
    $less->compileFile('less/1655.less', 'css/1655.css');
?>
<html lang="en">
    <head>
        <title>Module-1655</title>
        <meta charset="UTF-8">
        ...
        <link href="<?php echo $url_path ?>/css/1655.css" rel="stylesheet" type="text/css"/>
        <script src="<?php echo $url_path ?>/js/jquery-2.1.4.min.js" ></script>
        <script src="<?php echo $url_path ?>/js/1655.js" ></script>

    </head>
    <body>
        <?php include './module-1655-content.php'; ?>
    </body>
</html>